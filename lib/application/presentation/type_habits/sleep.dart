...
class SleepType extends StatefulWidget {
  const SleepType({Key? key}) : super(key: key);

  @override
  State<SleepType> createState() => _SleepTypeState();
}
...
class _SleepTypeState extends State<SleepType> {
