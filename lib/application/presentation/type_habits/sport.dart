...
class SportType extends StatefulWidget {
  const SportType({Key? key}) : super(key: key);
            ...
            child: Padding(
              ...
              child: CupertinoButton(
                ...
                onPressed: () {
                  ...
                  //no se deberian llamar dos habitos iguales sino va a dar problemas.
                  //deberia haber un validador para que si pasa no deje crearlo y le diga al usuario que ponga otro nombre
                  //no lo voy a hacer
                  print(type);
                  print(name);
                  print(repeat);
